...
const Privacy = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to DROP-N-GO.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to DROP-N-GO, accessible from{" "}
            <a
              href="https://www.drop-n-go.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.drop-n-go.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: support@dropandgo.com</li>
      </ul>
    </div>
  );
};
